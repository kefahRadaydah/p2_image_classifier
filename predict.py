...
parser.add_argument('--model', default='./flowermod.h5', action="store", type = str, help='checkpoint file path/name')
...
if __name__== "__main__":
    ...
    label_names = [class_names[str(int(idd))] for idd in classes]
    print(probs)
    print(classes)
    print(label_names)
